  ...
  <div id="container">
    <div id="stage">
      <div id="shape" class=" backfaces cube">
        ...
        <div class="plane two">H</div>
        <div class="plane three">A</div>
        <div class="plane four">C</div>
        <div class="plane five">K</div>
        <div class="plane six">🦊</div>
        <div class="plane seven"></div>
        <div class="plane eight">404</div>
        <div class="plane nine"></div>
        <div class="plane ten">404</div>
