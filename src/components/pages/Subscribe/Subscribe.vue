<template>
  <div>
    <div class="jumbotron">
      <div class="container">
        <h1>倉庫列表</h1>
        <router-link :to="{path: '/warehouse/add' }" class="btn btn-info float-right" active-class="active" exac>
            ...
            <tr v-for="data in datas" class="d-flex">
              ...
              <td class="col-4">
                <div class="btn-group">
                  ...
                  <router-link :to="{path: '/warehouse/'+ data.ID +'/del' }" class="btn btn-danger"
