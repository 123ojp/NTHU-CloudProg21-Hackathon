      ...
      <div class="mt2">
        ...
        <div>
          <div class="form-group">
            ...
            <input v-model="data.ID" class="form-control input-filled-valid" type="text" name="name" id="name-input"  disabled="disabled"  />
          </div>
          <div class="form-group">
  ...
  export default {
    ...
    methods: {
      ...
      readitem() {
        ...
        this.$http.get(this.$WHOUSE_API + "get?ID=" + item_id)
          .then((response) => {
